...
-- Top menu
local menu = workspace:addChild(GUI.menu(1, 0, workspace.width, 0x1D9D9D, 0x787878, 0x3366CC, 0xE1E1E1))
...
installerMenu:addItem("Exit aka crash it").onTouch = function()
	workspace:stop()
end
...
addStage(function()
	...
	if not selectedFilesystemProxy.getLabel() then
		selectedFilesystemProxy.setLabel("MODOS HDD")
	end
	...
	EEPROMProxy.setLabel("MODOS EFI")
